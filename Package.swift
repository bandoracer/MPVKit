...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/bandoracer/MPVKit/releases/download/1.0.0-marquee.2/Libmpv.xcframework.zip",
            checksum: "797d666988f6706cb4d101c49eae0fd223cc2e5fbd08223fa3b24cf045c7c67d"
        ),
