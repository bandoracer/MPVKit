...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/bandoracer/MPVKit/releases/download/1.0.0-marquee.1/Libmpv.xcframework.zip",
            checksum: "43f84bb4e14f8c043b0a6279d9162a546f750bec2cb4ae0b020d66aecb0e909b"
        ),
