...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/bandoracer/MPVKit/releases/download/1.0.0-marquee.3/Libmpv.xcframework.zip",
            checksum: "ed5819b1917fec719d5b1896b7e20b1f7e42442c4c017d7df6d675b92f0efb59"
        ),
